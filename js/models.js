...
class StoryList {
  ...
  async addStory( user, newStory) {
    ...
    const { story: {storyId, username, createdAt} } = response.data 
    const story = new Story({storyId,title,author,url,username,createdAt})
    this.stories.push(story)

   //  get the user and update the currentUser
    ...
    let { user: newUser } = userResponse.data
 ...
 */
  ...
  async deleteStory( user, storyId) {
    ...
    const { story: { username, author , url ,title, createdAt} } = response.data 
    const story = new Story({storyId,title,author,url,username,createdAt})
    this.stories = this.stories.filter(st => st.storyId !== story.storyId)
